...
namespace TurkAk.Migrations
{
    ...
    [Migration("20250530125958_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TurkAk.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.CustomersCertificate", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.NewDeviceType", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.ReferenceDeviceAdd", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.TurkAkacc", b =>
                {
            ...
            modelBuilder.Entity("TurkAk.Models.CustomersCertificate", b =>
                {
                    b.HasOne("TurkAk.Models.Employee", "CalibratorEmployeeNavigation")
                    ...
                    b.HasOne("TurkAk.Models.Customer", "CustomerNavigation")
                        .WithMany("CustomersCertificates")
                    ...
                    b.HasOne("TurkAk.Models.NewDeviceType", "DeviceTypeNavigation")
                        .WithMany("CustomersCertificates")
                        .HasForeignKey("DeviceType")
                        .IsRequired()
                        .HasConstraintName("FK__Customers__devic__47DBAE45");

                    b.HasOne("TurkAk.Models.ReferenceDeviceAdd", "ReferenceCalibratorNavigation")
                        .WithMany("CustomersCertificates")
